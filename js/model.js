...
Glycine = function() {
  ...
  var oxygen = new THREE.SphereGeometry(oxygenradius, 100, 100);
  var connector3 = new THREE.CylinderGeometry(.2 * carbonradius, .2 * carbonradius, 4 * (oxygenradius + hydroradius) / 2, 100, 100);
  var hydrogen = new THREE.SphereGeometry(hydroradius, 100, 100);
  var connector4 = new THREE.CylinderGeometry(.2 * carbonradius, .2 * carbonradius, 4 * (carbonradius + hydroradius) / 2, 100, 100);
  var connector5 = new THREE.CylinderGeometry(.2 * carbonradius, .2 * carbonradius, 4 * (carbonradius + nitrogenradius) / 2, 100, 100);
  var nitrogen = new THREE.SphereGeometry(nitrogenradius, 100, 100);
  var connector7 = new THREE.CylinderGeometry(.2 * carbonradius, .2 * carbonradius, 4 * (nitrogenradius + hydroradius) / 2, 100, 100);
  ...
  var doublemat = new THREE.MeshPhongMaterial({
    color: Colors.pink,
    transparent: true,
    opacity: .9,
    shading: THREE.FlatShading,
  ...
  var oxygenmat = new THREE.MeshPhongMaterial({
    color: Colors.red,
    transparent: true,
    opacity: 1,
    shading: THREE.FlatShading,
  ...
  var hydromat = new THREE.MeshPhongMaterial({
    color: Colors.white,
    transparent: true,
    opacity: 1,
    shading: THREE.FlatShading,
  ...
  var nitromat = new THREE.MeshPhongMaterial({
    color: Colors.brownDark,
    transparent: true,
    opacity: 1,
    shading: THREE.FlatShading,
  ...
  c1 = new THREE.Mesh(carbon, carbonmat);
  c2 = new THREE.Mesh(carbon, carbonmat);
  c1.position.x -= 2 * carbonradius
  c2.position.x += 2 * carbonradius;

  co1 = new THREE.Mesh(connector1, connectormat);
  co1.rotation.z = Math.PI / 2;
...
function createGlycine() {
  glycine = new Glycine();
  glycine.mesh.position.y = 100;
  //glycine.mesh.rotation.y = Math.PI/2;
  scene.add(glycine.mesh);
}
